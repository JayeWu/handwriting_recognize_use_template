...
class BaseModel:
    ...
    def save(self, sess):
        print("Saving model...")
        self.saver.save(sess, self.config.checkpoint_dir+'model.ckpt', self.global_step_tensor)
        tf.train.write_graph(sess.graph_def, self.config.graph_dir, "train.pb", False)
        print("Model saved")
